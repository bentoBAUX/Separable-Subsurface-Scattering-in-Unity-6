...
namespace bentoBAUX
{
    public class PBRGUI : ShaderGUI
    {
        ...
        // Parallax Mapping
        private MaterialProperty _DepthMap;
        private MaterialProperty _NumberOfLayers;
        private MaterialProperty _DepthScale;
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            DrawParallaxMappingSection(materialEditor);
            EditorGUILayout.Space();
        ...
        private void CacheProperties(MaterialProperty[] props)
        {
            ...
            // Parallax Mapping
            _DepthMap = FindProperty("_DepthMap", props, false);
            _NumberOfLayers = FindProperty("_NumberOfLayers", props, false);
            _DepthScale = FindProperty("_DepthScale", props, false);
        ...
        private void DrawParallaxMappingSection(MaterialEditor materialEditor)
        {
            EditorGUILayout.LabelField("Parallax Mapping", EditorStyles.boldLabel);
            materialEditor.TexturePropertySingleLine(new GUIContent("Depth Map"), _DepthMap);
            materialEditor.IntegerProperty(_NumberOfLayers, "Number of Layers");
            materialEditor.FloatProperty(_DepthScale, "Depth Scale");
        }
